...
val_mens_fin, val_mens_debut = cal_mens_lisse(150000, 350, p1*12, duree_tot*12,
                                              taux_annuel/12., taux_annuel_p1/12)

print "Exemple de 175000 sur 20 ans avec un palier de 300 après " + str(p1) + " ans. début : " + str(val_mens_debut) + " Fin : " + str(val_mens_fin)
