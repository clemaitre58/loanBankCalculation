...
apport =  0.
mont_operation = cal_frais_notaire(140000)-140000+140000-apport
print "Montant opération : " + str(mont_operation)
val_mens_fin, val_mens_debut = cal_mens_lisse(mont_operation, 400, p1*12, duree_tot*12,
                                              taux_annuel/12., taux_annuel_p1/12)
print "Frais de notaire : " + str(cal_frais_notaire(140000)-140000) 
print "Exemple de 135 000 + frais de notaire sur 25 ans avec un palier après : " + str(p1) + " ans. début : " + str(val_mens_debut) + " Fin : " + str(val_mens_fin)
